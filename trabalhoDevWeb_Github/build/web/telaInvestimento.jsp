...
<div class="container-fluid TI">
    <fieldset class="d-flex flex-column justify-content-center">
                ...
                <div class="d-flex justify-content-center">
                    <div class="card text-white bg-secondary mb-3" style="width: 18rem;">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item text-center" id="saldo">R$</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-6"> <!-- Adicionado outro col-md-6 -->
                <div class="d-flex justify-content-center">
                    <div class="card text-white bg-secondary mb-3" style="width: 18rem;">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item text-center" id="investimentos">R$</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 justify-content-center d-flex">
            <form class="col-md-6" action="acoesAdminConsultaSimples" method="post">
