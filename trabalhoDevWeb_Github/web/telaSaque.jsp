<%-- 
    Document   : telaSaque
    Created on : 12 de nov. de 2023, 16:05:28
    Author     : Usuário
--%>
...
<div class="container-fluid TI">
    <fieldset class="d-flex flex-column justify-content-center">
        <legend class="titleInfo text-center my-4">Saque</legend>
        ...
        <div class="col-md-12 justify-content-center d-flex">
            <form class="col-md-6" action="acoesAdminConsultaSimples" method="post">
                <div class="form-group my-5">
                    <label class="text-white" for="exampleInputName">Valor a ser sacado da conta</label>
