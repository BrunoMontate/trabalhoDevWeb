<%-- 
    Document   : telaInvestimento
    Created on : 12 de nov. de 2023, 16:04:20
    Author     : Usuário
--%>
...
<%
    ...
    Double investimento = (Double) session.getAttribute("valInvestido");
%>
<html lang="pt-br">
...
<div class="container-fluid TI">
    <fieldset class="d-flex flex-column justify-content-center">
        <legend class="titleInfo text-center my-4">Investimento</legend>
        <div class="row justify-content-center"> <!-- Adicionado a classe row -->
            <div class="col-md-6"> <!-- Adicionado a classe col-md-6 para ocupar metade da largura -->
            ...
            <div class="col-md-6"> <!-- Adicionado outro col-md-6 -->
                <div class="d-flex justify-content-center">
                    <div class="card text-white bg-secondary mb-3" style="width: 18rem;">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item text-center" id="investimentos">R$<%=investimento%></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 justify-content-center d-flex">
            <form class="col-md-6" action="usuarioInvestimento" method="post">
                ...
                <div class="form-group my-5">
                    <label class="text-white" for="exampleInputName">Valor a ser investido</label>
        ...
        <p class="titleInfo text-center my-4">Colocando seu dinheiro em nossos investimentos, garantimos uma rentabilidade de <strong>0,5%</strong> ao dia!</p>
                    <br>
            <% if (mensagem != null) { %>
